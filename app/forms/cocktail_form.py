...
from wtforms import StringField, TextAreaField, FieldList, FormField, SubmitField, FileField
...
class CocktailForm(FlaskForm):
    ...
    image = FileField("Cocktail Image", validators=[FileAllowed(["jpg", "png"], "Images only!")])
    ...
    def validate_image(form, field):
        if field.data and not field.data.filename.lower().endswith((".jpg", ".jpeg", ".png")):
